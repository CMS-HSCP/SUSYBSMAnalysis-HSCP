...
void loadDeDxParameters(int CurrentRun, int SampleType, double &dEdxSF_0, double &dEdxSF_1, double &dEdxK,double &dEdxC){
...
class dedxGainCorrector{
   ...
   public:
      ...
      void setRun(unsigned int currentRun){
         if(TrackerGainsPerRuns.size()<=0){TrackerGains=nullptr; return;}
