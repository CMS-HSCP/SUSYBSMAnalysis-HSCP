...
void MCWeight::getSampleWeights(TString period, const TString pattern, double &IntegratedLuminosity, double &CrossSection){
  ...
  if      (period.Contains("2018")) IntegratedLuminosity = 58970.47;
  else if (period.Contains("2017")) IntegratedLuminosity = 41809.45;
  else if (period.Contains("2016")) IntegratedLuminosity = 35552.24;
  else {
...
void MCWeight::getRHadronWeights(std::string sample_name, bool Rhadron, double  &Wa, double  &Wad, double  &Waa, double  &Wan){
