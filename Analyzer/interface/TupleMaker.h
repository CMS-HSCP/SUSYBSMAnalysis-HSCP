...
void TupleMaker::initializeTuple(Tuple *&tuple,
  ...
  tuple->PrePreS_Chi2oNdof = dir.make<TH1F>(Name.c_str(), Name.c_str(), 20, 0, 20);
  tuple->PrePreS_Chi2oNdof->Sumw2();
  Name = "PrePreS_Qual";
  ...
  Name = "PrePreS_Ias";
  tuple->PrePreS_Ias = dir.make<TH1F>(Name.c_str(), Name.c_str(), 50, 0, dEdxS_UpLim);
  tuple->PrePreS_Ias->Sumw2();
  Name = "PrePreS_Ih";
  ...
  Name = "PrePreS_EoP";
  tuple->PrePreS_EoP = dir.make<TH1F>(Name.c_str(), Name.c_str(), 25, 0, 1.5);
  tuple->PrePreS_EoP->Sumw2();
  ...
  Name = "PrePreS_Ias";
  tuple->PrePreS_Ias = dir.make<TH1F>(Name.c_str(), Name.c_str(), 100, 0, dEdxS_UpLim);
  tuple->PrePreS_Ias->Sumw2();
  Name = "PrePreS_Ias_PUA";
  tuple->PrePreS_Ias_PUA = dir.make<TH1F>(Name.c_str(), Name.c_str(), 100, 0, dEdxS_UpLim);
  tuple->PrePreS_Ias_PUA->Sumw2();
  Name = "PrePreS_Ias_PUB";
  tuple->PrePreS_Ias_PUB = dir.make<TH1F>(Name.c_str(), Name.c_str(), 100, 0, dEdxS_UpLim);
  tuple->PrePreS_Ias_PUB->Sumw2();
  Name = "PrePreS_Ias_Cosmic";
  tuple->PrePreS_Ias_Cosmic = dir.make<TH1F>(Name.c_str(), Name.c_str(), 100, 0, dEdxS_UpLim);
  tuple->PrePreS_Ias_Cosmic->Sumw2();
  Name = "PrePreS_Ih_Cosmic";
  tuple->PrePreS_Ih_Cosmic = dir.make<TH1F>(Name.c_str(), Name.c_str(), 200, 0, dEdxM_UpLim);
  tuple->PrePreS_Ih_Cosmic->Sumw2();
  Name = "PrePreS_Ih";
  tuple->PrePreS_Ih = dir.make<TH1F>(Name.c_str(), Name.c_str(), 200, 0, dEdxM_UpLim);
  tuple->PrePreS_Ih->Sumw2();
  Name = "PrePreS_Ih_PUA";
  ...
  Name = "PostPreS_Ias";
  tuple->PostPreS_Ias = dir.make<TH1F>(Name.c_str(), Name.c_str(), 50, 0, dEdxS_UpLim);
  tuple->PostPreS_Ias->Sumw2();
  Name = "PostPreS_Ias_NoEventWeight";
  tuple->PostPreS_Ias_NoEventWeight = dir.make<TH1F>(Name.c_str(), Name.c_str(), 50, 0, dEdxS_UpLim);
  ...
  tuple->PostPreS_IasVsMomGenID = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, 0, dEdxS_UpLim, 4000, 0.0, 4000.0);
  ...
  tuple->PostPreS_IasVsSiblingGenID = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, 0, dEdxS_UpLim, 4000, 0.0, 4000.0);
  ...
  tuple->PostPreS_IasVsGenAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, 0, dEdxS_UpLim, 100, 0.0, 1.0);
  ...
  tuple->PostPreS_IasVsGenMomAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, 0, dEdxS_UpLim, 100, 0.0, 1.0);
  ...
  tuple->PostPreS_IasVsGenNumSibling = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, 0, dEdxS_UpLim, 100, 0.0, 10.0);
  ...
  Name = "PostPreS_HighIasPixelL1ProbQVsProbXY";
  tuple->PostPreS_HighIasPixelL1ProbQVsProbXY = dir.make<TH3F>(Name.c_str(), Name.c_str(), 200, 0., dEdxM_UpLim,  100, 0.0, 1.0, 100, 0.0, 1.0);
  tuple->PostPreS_HighIasPixelL1ProbQVsProbXY->Sumw2();
  Name = "PostPreS_LowIasPixelL1ProbQVsProbXY";
  tuple->PostPreS_LowIasPixelL1ProbQVsProbXY = dir.make<TH3F>(Name.c_str(), Name.c_str(), 200, 0., dEdxM_UpLim,  100, 0.0, 1.0, 100, 0.0, 1.0);
  tuple->PostPreS_LowIasPixelL1ProbQVsProbXY->Sumw2();
  Name = "PostPreS_HighIasPixelL2ProbQVsProbXY";
  tuple->PostPreS_HighIasPixelL2ProbQVsProbXY = dir.make<TH3F>(Name.c_str(), Name.c_str(), 200, 0., dEdxM_UpLim,  100, 0.0, 1.0, 100, 0.0, 1.0);
  tuple->PostPreS_HighIasPixelL2ProbQVsProbXY->Sumw2();
  ...
  tuple->AS_Pt->Sumw2();
  Name = "AS_Ias";
  tuple->AS_Ias = dir.make<TH2F>(Name.c_str(), Name.c_str(), NCuts, 0, NCuts, 50, 0, dEdxS_UpLim);
  tuple->AS_Ias->Sumw2();
  Name = "AS_Ih";
  ...
  tuple->PrePreS_EtaVsIas = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, -3, 3, 50, 0, dEdxS_UpLim);
  Name = "PrePreS_EtaVsIh";
  tuple->PrePreS_EtaVsIh = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, -3, 3, 100, 0, dEdxM_UpLim);
  Name = "PrePreS_EtaVsP";
  tuple->PrePreS_EtaVsP = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, -3, 3, 50, 0, PtHistoUpperBound);
  Name = "PrePreS_EtaVsPt";
  tuple->PrePreS_EtaVsPt = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, -3, 3, 50, 0, PtHistoUpperBound);
  Name = "PrePreS_EtaVsTOF";
  tuple->PrePreS_EtaVsTOF = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, -3, 3, 50, 0, 3);
  Name = "PrePreS_EtaVsNBH";
  tuple->PrePreS_EtaVsNBH = dir.make<TH2F>(Name.c_str(), Name.c_str(), 60, -3, 3, 24, 0, 24);
  Name = "PrePreS_EtaVsDz";
  tuple->PrePreS_EtaVsDz = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, -3, 3, 50, -IPbound, IPbound);
  Name = "PrePreS_PVsIas";
  tuple->PrePreS_PVsIas = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, 0, PtHistoUpperBound, 100, 0, dEdxS_UpLim);
  Name = "PrePreS_IhVsIas";
  tuple->PrePreS_IhVsIas = dir.make<TH2F>(Name.c_str(), Name.c_str(), 100, 0, dEdxM_UpLim, 100, 0, dEdxS_UpLim);
  Name = "PrePreS_PVsIh";
  tuple->PrePreS_PVsIh = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, 0, PtHistoUpperBound, 100, 0, dEdxM_UpLim);
  Name = "PrePreS_PtVsIas";
  tuple->PrePreS_PtVsIas = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, 0, PtHistoUpperBound, 50, 0, dEdxS_UpLim);
  Name = "PrePreS_PtVsIh";
  tuple->PrePreS_PtVsIh = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, 0, PtHistoUpperBound, 100, 0, dEdxM_UpLim);
  Name = "PrePreS_PtTOF";
