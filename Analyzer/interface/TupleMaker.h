...
void TupleMaker::initializeTuple(Tuple *&tuple,
  ...
  Name = "N1_TNOH";
  tuple->N1_TNOH = dir.make<TH1F>(Name.c_str(), Name.c_str(), 40, 0, 40);
  Name = "N1_TNOM";
  tuple->N1_TNOM = dir.make<TH1F>(Name.c_str(), Name.c_str(), 40, 0, 40);
  Name = "N1_TNOPH";
  ...
  Name = "PrePreS_TNOH";
  tuple->PrePreS_TNOH = dir.make<TH1F>(Name.c_str(), Name.c_str(), 40, 0, 40);
  tuple->PrePreS_TNOH->Sumw2();
  Name = "PrePreS_TNOH_PUA";
  tuple->PrePreS_TNOH_PUA = dir.make<TH1F>(Name.c_str(), Name.c_str(), 40, 0, 40);
  tuple->PrePreS_TNOH_PUA->Sumw2();
  Name = "PrePreS_TNOH_PUB";
  tuple->PrePreS_TNOH_PUB = dir.make<TH1F>(Name.c_str(), Name.c_str(), 40, 0, 40);
  ...
  Name = "PrePreS_TNOPH";
  tuple->PrePreS_TNOPH = dir.make<TH1F>(Name.c_str(), Name.c_str(), 8, 0, 8.);
  ...
  Name = "PrePreS_nDof";
  tuple->PrePreS_nDof = dir.make<TH1F>(Name.c_str(), Name.c_str(), 40, 0, 40);
  ...
  Name = "PrePreS_Dxy";
  tuple->PrePreS_Dxy = dir.make<TH1F>(Name.c_str(), Name.c_str(), 200, -0.1, 0.1);
  tuple->PrePreS_Dxy->Sumw2();
  ...
  Name = "PrePreS_Dz";
  tuple->PrePreS_Dz = dir.make<TH1F>(Name.c_str(), Name.c_str(), 200, -0.1, 0.1);
  tuple->PrePreS_Dz->Sumw2();
  ...
  Name = "PostPreS_TNOH";
  tuple->PostPreS_TNOH = dir.make<TH1F>(Name.c_str(), Name.c_str(), 40, 0, 40);
  ...
  Name = "PostPreS_miniIsoChgPerGenID";
  tuple->PostPreS_miniIsoChgPerGenID = dir.make<TH2F>(Name.c_str(), Name.c_str(), 20, 0.0, 1.0, 4000, 0.0, 4000.0);
  tuple->PostPreS_miniIsoChgPerGenID->Sumw2();
  Name = "PostPreS_miniIsoAllPerGenID";
  tuple->PostPreS_miniIsoAllPerGenID = dir.make<TH2F>(Name.c_str(), Name.c_str(), 20, 0.0, 1.0, 4000, 0.0, 4000.0);
  tuple->PostPreS_miniIsoAllPerGenID->Sumw2();
  ...
  Name = "PostPreS_miniIsoChgPerMomGenID";
  tuple->PostPreS_miniIsoChgPerMomGenID = dir.make<TH2F>(Name.c_str(), Name.c_str(), 20, 0.0, 1.0, 4000, 0.0, 4000.0);
  tuple->PostPreS_miniIsoChgPerMomGenID->Sumw2();
  Name = "PostPreS_miniIsoAllPerMomGenID";
  tuple->PostPreS_miniIsoAllPerMomGenID = dir.make<TH2F>(Name.c_str(), Name.c_str(), 20, 0.0, 1.0, 4000, 0.0, 4000.0);
  tuple->PostPreS_miniIsoAllPerMomGenID->Sumw2();
  
  Name = "PostPreS_EtaPerSiblingGenID";
  tuple->PostPreS_EtaPerSiblingGenID = dir.make<TH2F>(Name.c_str(), Name.c_str(),  50, -2.6, 2.6, 4000, 0.0, 4000.0);
  tuple->PostPreS_EtaPerSiblingGenID->Sumw2();
  Name = "PostPreS_ProbQPerSiblingGenID";
  tuple->PostPreS_ProbQPerSiblingGenID = dir.make<TH2F>(Name.c_str(), Name.c_str(), 100, 0.0, 1.0, 4000, 0.0, 4000.0);
  tuple->PostPreS_ProbQPerSiblingGenID->Sumw2();
  Name = "PostPreS_ProbXYPerSiblingGenID";
  tuple->PostPreS_ProbXYPerSiblingGenID = dir.make<TH2F>(Name.c_str(), Name.c_str(), 100, 0.0, 1.0, 4000, 0.0, 4000.0);
  tuple->PostPreS_ProbXYPerSiblingGenID->Sumw2();
  Name = "PostPreS_PtPerSiblingGenID";
  tuple->PostPreS_PtPerSiblingGenID = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, 0, PtHistoUpperBound, 4000, 0.0, 4000.0);
  tuple->PostPreS_PtPerSiblingGenID->Sumw2();
  Name = "PostPreS_EIsolPerSiblingGenID";
  tuple->PostPreS_EIsolPerSiblingGenID = dir.make<TH2F>(Name.c_str(), Name.c_str(), 25, 0, 1.5, 4000, 0.0, 4000.0);
  tuple->PostPreS_EIsolPerSiblingGenID->Sumw2();
  Name = "PostPreS_MIhPerSiblingGenID";
  tuple->PostPreS_MIhPerSiblingGenID = dir.make<TH2F>(Name.c_str(), Name.c_str(), 200, 0, dEdxM_UpLim, 4000, 0.0, 4000.0);
  tuple->PostPreS_MIhPerSiblingGenID->Sumw2();
  Name = "PostPreS_MIsPerSiblingGenID";
  tuple->PostPreS_MIsPerSiblingGenID = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, 0, dEdxS_UpLim, 4000, 0.0, 4000.0);
  tuple->PostPreS_MIsPerSiblingGenID ->Sumw2();
  Name = "PostPreS_massTPerSiblingGenID";
  tuple->PostPreS_massTPerSiblingGenID = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, 0.0, 250.0, 4000, 0.0, 4000.0);
  tuple->PostPreS_massTPerSiblingGenID->Sumw2();
  
  Name = "PostPreS_EtaPerGenAngle";
  tuple->PostPreS_EtaPerGenAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(),  50, -2.6, 2.6, 100, 0.0, 1.0);
  tuple->PostPreS_EtaPerGenAngle->Sumw2();
  Name = "PostPreS_ProbQPerGenAngle";
  tuple->PostPreS_ProbQPerGenAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 100, 0.0, 1.0, 100, 0.0,1.0);
  tuple->PostPreS_ProbQPerGenAngle->Sumw2();
  Name = "PostPreS_ProbXYPerGenAngle";
  tuple->PostPreS_ProbXYPerGenAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 100, 0.0, 1.0, 100, 0.0, 1.0);
  tuple->PostPreS_ProbXYPerGenAngle->Sumw2();
  Name = "PostPreS_PtPerGenAngle";
  tuple->PostPreS_PtPerGenAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, 0, PtHistoUpperBound, 100, 0.0, 1.0);
  tuple->PostPreS_PtPerGenAngle->Sumw2();
  Name = "PostPreS_EIsolPerGenAngle";
  tuple->PostPreS_EIsolPerGenAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 25, 0, 1.5, 100, 0.0, 1.0);
  tuple->PostPreS_EIsolPerGenAngle->Sumw2();
  Name = "PostPreS_MIhPerGenAngle";
  tuple->PostPreS_MIhPerGenAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 200, 0, dEdxM_UpLim, 100, 0.0, 1.0);
  tuple->PostPreS_MIhPerGenAngle->Sumw2();
  Name = "PostPreS_MIsPerGenAngle";
  tuple->PostPreS_MIsPerGenAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, 0, dEdxS_UpLim, 100, 0.0, 1.0);
  tuple->PostPreS_MIsPerGenAngle ->Sumw2();
  Name = "PostPreS_massTPerGenAngle";
  tuple->PostPreS_massTPerGenAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, 0.0, 250.0, 100, 0.0, 1.0);
  tuple->PostPreS_massTPerGenAngle->Sumw2();
  Name = "PostPreS_miniIsoChgPerGenAngle";
  tuple->PostPreS_miniIsoChgPerGenAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 20, 0.0, 1.0, 100, 0.0, 1.0);
  tuple->PostPreS_miniIsoChgPerGenAngle->Sumw2();
  Name = "PostPreS_miniIsoAllPerGenAngle";
  tuple->PostPreS_miniIsoAllPerGenAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 20, 0.0, 1.0, 100, 0.0, 1.0);
  tuple->PostPreS_miniIsoAllPerGenAngle->Sumw2();
  
  Name = "PostPreS_EtaPerGenMomAngle";
  tuple->PostPreS_EtaPerGenMomAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(),  50, -2.6, 2.6, 100, 0.0, 1.0);
  tuple->PostPreS_EtaPerGenMomAngle->Sumw2();
  Name = "PostPreS_ProbQPerGenMomAngle";
  tuple->PostPreS_ProbQPerGenMomAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 100, 0.0, 1.0, 100, 0.0,1.0);
  tuple->PostPreS_ProbQPerGenMomAngle->Sumw2();
  Name = "PostPreS_ProbXYPerGenMomAngle";
  tuple->PostPreS_ProbXYPerGenMomAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 100, 0.0, 1.0, 100, 0.0, 1.0);
  tuple->PostPreS_ProbXYPerGenMomAngle->Sumw2();
  Name = "PostPreS_PtPerGenMomAngle";
  tuple->PostPreS_PtPerGenMomAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, 0, PtHistoUpperBound, 100, 0.0, 1.0);
  tuple->PostPreS_PtPerGenMomAngle->Sumw2();
  Name = "PostPreS_EIsolPerGenMomAngle";
  tuple->PostPreS_EIsolPerGenMomAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 25, 0, 1.5, 100, 0.0, 1.0);
  tuple->PostPreS_EIsolPerGenMomAngle->Sumw2();
  Name = "PostPreS_MIhPerGenMomAngle";
  tuple->PostPreS_MIhPerGenMomAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 200, 0, dEdxM_UpLim, 100, 0.0, 1.0);
  tuple->PostPreS_MIhPerGenMomAngle->Sumw2();
  Name = "PostPreS_MIsPerGenMomAngle";
  tuple->PostPreS_MIsPerGenMomAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, 0, dEdxS_UpLim, 100, 0.0, 1.0);
  tuple->PostPreS_MIsPerGenMomAngle ->Sumw2();
  Name = "PostPreS_massTPerGenMomAngle";
  tuple->PostPreS_massTPerGenMomAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, 0.0, 250.0, 100, 0.0, 1.0);
  tuple->PostPreS_massTPerGenMomAngle->Sumw2();
  Name = "PostPreS_miniIsoChgPerGenMomAngle";
  tuple->PostPreS_miniIsoChgPerGenMomAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 20, 0.0, 1.0, 100, 0.0, 1.0);
  tuple->PostPreS_miniIsoChgPerGenMomAngle->Sumw2();
  ...
  tuple->PostPreS_MIsAllIhPerLayer->Sumw2();
  Name = "PostPreS_MIsPixelIhPerLayer";
  tuple->PostPreS_MIsPixelIhPerLayer = dir.make<TH3F>(Name.c_str(), Name.c_str(), 50, 0., dEdxS_UpLim, 200, 0., dEdxM_UpLim, 10, 0.,10.);
  tuple->PostPreS_MIsPixelIhPerLayer->Sumw2();
