...
//  tuple->N1_tofError = dir.make<TH1F>("tofError", ";tofError", 25, 0, 0.25);
  ...
  tuple->N1_ProbQNoLayer1 = dir.make<TH1F>("N1_ProbQNoLayer1", ";F_{I}^{pixels};Tracks / 0.01", 40, 0., 1.);
  tuple->N1_ProbQNoLayer1VsIas = dir.make<TH2F>("N1_ProbQNoLayer1VsIas", ";F_{I}^{pixels};G_{I}^{strips}", 100, 0.0, 1.0, 100, 0.0, 1.0);
  tuple->N1_IhVsProbQNoLayer1VsIas = dir.make<TH3F>("N1_IhVsProbQNoLayer1VsIas", ";I_{h} (MeV/cm);F_{I}^{pixels};G_{I}^{strips}",200, 0, dEdxM_UpLim, 100, 0.0, 1.0, 100, 0.0, 1.0);
