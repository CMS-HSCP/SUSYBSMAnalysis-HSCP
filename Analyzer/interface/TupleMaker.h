...
void TupleMaker::initializeTuple(Tuple *&tuple,
  ...
  tuple->PostPreS_EtaPerGenAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(),  50, -2.6, 2.6, 4000, 0.0, 4000.0);
  tuple->PostPreS_EtaPerGenAngle->Sumw2();
  Name = "PostPreS_ProbQPerGenAngle";
  tuple->PostPreS_ProbQPerGenAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 100, 0.0, 1.0, 4000, 0.0, 4000.0);
  tuple->PostPreS_ProbQPerGenAngle->Sumw2();
  Name = "PostPreS_ProbXYPerGenAngle";
  tuple->PostPreS_ProbXYPerGenAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 100, 0.0, 1.0, 4000, 0.0, 4000.0);
  tuple->PostPreS_ProbXYPerGenAngle->Sumw2();
  Name = "PostPreS_PtPerGenAngle";
  tuple->PostPreS_PtPerGenAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, 0, PtHistoUpperBound, 4000, 0.0, 4000.0);
  tuple->PostPreS_PtPerGenAngle->Sumw2();
  Name = "PostPreS_EIsolPerGenAngle";
  tuple->PostPreS_EIsolPerGenAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 25, 0, 1.5, 4000, 0.0, 4000.0);
  tuple->PostPreS_EIsolPerGenAngle->Sumw2();
  Name = "PostPreS_MIhPerGenAngle";
  tuple->PostPreS_MIhPerGenAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 200, 0, dEdxM_UpLim, 4000, 0.0, 4000.0);
  tuple->PostPreS_MIhPerGenAngle->Sumw2();
  Name = "PostPreS_MIsPerGenAngle";
  tuple->PostPreS_MIsPerGenAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, 0, dEdxS_UpLim, 4000, 0.0, 4000.0);
  tuple->PostPreS_MIsPerGenAngle ->Sumw2();
  Name = "PostPreS_massTPerGenAngle";
  tuple->PostPreS_massTPerGenAngle = dir.make<TH2F>(Name.c_str(), Name.c_str(), 50, 0.0, 250.0, 4000, 0.0, 4000.0);
