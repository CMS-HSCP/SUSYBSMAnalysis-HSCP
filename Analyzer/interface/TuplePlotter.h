...
void TuplePlotter::getObjects(Tuple*& tuple, TDirectory* dir) {
  ...
  Name = "BS_MIm";
  tuple->BS_MIm = (TH1F*)GetObjectFromPath(dir, path + "/" + Name);
  Name = "BS_MTOF";
  ...
  Name = "BS_Im";
  tuple->BS_Im = (TH1F*)GetObjectFromPath(dir, path + "/" + Name);
  Name = "BS_Im_PUA";
  tuple->BS_Im_PUA = (TH1F*)GetObjectFromPath(dir, path + "/" + Name);
  Name = "BS_Im_PUB";
  tuple->BS_Im_PUB = (TH1F*)GetObjectFromPath(dir, path + "/" + Name);
  Name = "BS_TOF";
  ...
  Name = "AS_Im";
  tuple->AS_Im = (TH2F*)GetObjectFromPath(dir, path + "/" + Name);
  Name = "AS_TOF";
  ...
  Name = "BS_EtaIm";
  tuple->BS_EtaIm = (TH2F*)GetObjectFromPath(dir, path + "/" + Name);
  Name = "BS_EtaP";
  ...
  Name = "BS_PImHD";
  tuple->BS_PImHD = (TH2F*)GetObjectFromPath(dir, path + "/" + Name);
  Name = "BS_PIm";
  tuple->BS_PIm = (TH2F*)GetObjectFromPath(dir, path + "/" + Name);
  Name = "BS_PtIs";
  tuple->BS_PtIs = (TH2F*)GetObjectFromPath(dir, path + "/" + Name);
  Name = "BS_PtIm";
  tuple->BS_PtIm = (TH2F*)GetObjectFromPath(dir, path + "/" + Name);
  Name = "BS_PtTOF";
  ...
  Name = "BS_TOFIm";
  tuple->BS_TOFIm = (TH2F*)GetObjectFromPath(dir, path + "/" + Name);
  ...
  Name = "AS_PIm";
  tuple->AS_PIm = (TH3F*)GetObjectFromPath(dir, path + "/" + Name);
  Name = "AS_PtIs";
  tuple->AS_PtIs = (TH3F*)GetObjectFromPath(dir, path + "/" + Name);
  Name = "AS_PtIm";
  tuple->AS_PtIm = (TH3F*)GetObjectFromPath(dir, path + "/" + Name);
  Name = "AS_TOFIs";
  tuple->AS_TOFIs = (TH3F*)GetObjectFromPath(dir, path + "/" + Name);
  Name = "AS_TOFIm";
  tuple->AS_TOFIm = (TH3F*)GetObjectFromPath(dir, path + "/" + Name);
}
