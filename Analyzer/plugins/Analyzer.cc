...
//skip templates_Ias = 2 --> Pixel Only
    ...
    double dEdxErr = 0;
    auto dedxSObjTmp =
        computedEdx(iEvent, year, dedxHits, dEdxSF, dEdxTemplates, true, useClusterCleaning, TypeMode_ == 5, false, trackerCorrector.TrackerGains,
    ...
    //Ih
    auto dedxMObjTmp =
        computedEdx(iEvent, year, dedxHits, dEdxSF, nullptr, true, useClusterCleaning, false, false, trackerCorrector.TrackerGains,
    ...
    auto dedxIh_StripOnly_Tmp =
        computedEdx(iEvent, year, dedxHits, dEdxSF, nullptr, false, useClusterCleaning, false, false, trackerCorrector.TrackerGains,
    ...
    auto dedx_probQ_Tmp =
        computedEdx(iEvent, year, dedxHits, dEdxSF, dEdxTemplates, true, useClusterCleaning, true, false, trackerCorrector.TrackerGains,
