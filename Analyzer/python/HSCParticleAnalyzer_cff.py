...
analyzer_2016 = SUSYBSMAnalysis.Analyzer.HSCParticleAnalyzer_cfi.HSCParticleAnalyzer.clone(
...
analyzer_2017 = SUSYBSMAnalysis.Analyzer.HSCParticleAnalyzer_cfi.HSCParticleAnalyzer.clone(
    DeDxSF_0        = cms.untracked.double(1.00000), #=1 if data
    DeDxSF_1        = cms.untracked.double(1.0325), #2017 data
    DeDxK           = cms.untracked.double(2.30),
    DeDxC           = cms.untracked.double(3.17),
...
analyzer_2018 = SUSYBSMAnalysis.Analyzer.HSCParticleAnalyzer_cfi.HSCParticleAnalyzer.clone(
    DeDxSF_0        = cms.untracked.double(1.00000), #=1 if data
