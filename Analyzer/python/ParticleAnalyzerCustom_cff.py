...
analyzer = cms.EDAnalyzer('Analyzer'
    ...
    #,genParticleCollection = cms.InputTag("genParticles","","DIGI2RAW")
    ...
    #,Trigger_MET  = cms.untracked.vstring("HLToPFMET170_HBHECleaned_v","HLT_PFMET170_NoiseCleaned")
    ...
    ,SampleName      = cms.untracked.string("Test_1_Gluino1800")
    ,Period          = cms.untracked.string("2022")
    ...
    ,Scenario              = cms.untracked.string("both")
)
