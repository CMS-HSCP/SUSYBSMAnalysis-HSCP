...
f2 = ROOT.TFile.Open("crab_Analysis_2018_AllBackground_CodeV42p8_v1.root")
...
legProjXInRegions.AddEntry(projFailPt3, "p_{T} = 1000 - inf GeV","LP")
legProjXInRegions.Draw("SAMEP")
canLog3.SaveAs("AllBkg_Gi_PtBins_FAIL.png")
...
legProjXInRegions.Draw("SAMEP")
canLog32.SaveAs("AllBkg_Gi_PtBins_PASS.png")
