...
process = cms.Process("HSCPAnalysis", Run3)
...
#         'file:AOD_MB_default_2022.root',
         'file:/afs/cern.ch/user/t/tvami/public/HSCP/Run3DeDxEstimator/ChangePresc/CMSSW_12_4_X_2022-03-21-1100/src/AOD_MB_mod_2022.root'
    ),
)
...
process.stage = cms.EDAnalyzer('ntuple'
     ...
     , isoHSCP0           = cms.InputTag("HSCPIsolation","R01")
...
process.TFileService = cms.Service("TFileService",
     fileName = cms.string('nt_data.root')
 )
