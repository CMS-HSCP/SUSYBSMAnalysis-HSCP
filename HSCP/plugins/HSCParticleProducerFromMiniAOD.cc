...
bool
HSCParticleProducerFromMiniAOD::filter(edm::Event& iEvent, const edm::EventSetup& iSetup) {
...
void
HSCParticleProducerFromMiniAOD::beginJob() {
}

// ------------ method called once each job just after ending the event loop  ------------
void
HSCParticleProducerFromMiniAOD::endJob() {
}
