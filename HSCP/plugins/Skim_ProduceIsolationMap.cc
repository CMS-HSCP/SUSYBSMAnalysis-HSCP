...
// version in 12_1_0
         TrackDetMatchInfo info = trackAssociator_.associate(iEvent, iSetup, trackAssociator_.getFreeTrajectoryState(&iSetup.getData(parameters_.bFieldToken), *itTrack), parameters_);
         for(unsigned int i=0;i<Label_.size();i++){
