...
#include "Riostream.h"
  ...
  TH2F* simHitsEcalDigiMatchEnergyVsTimeHistEB_ =
      (TH2F*)(theFile1->Get("hscpValidator/ecalEnergyVsTimeOfDigiMatSimHitsEB"));
  TH2F* simHitsEcalDigiMatchEnergyVsTimeHistEE_ =
      (TH2F*)(theFile1->Get("hscpValidator/ecalEnergyVsTimeOfDigiMatSimHitsEE"));
  ...
  for (int i = 0; i < 6; i++)
    rpcTimeOfFlightBarrel_[i]->SetMaximum(max);
