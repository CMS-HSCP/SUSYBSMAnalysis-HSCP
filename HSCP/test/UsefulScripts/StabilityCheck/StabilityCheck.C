...
struct plotSt {
  ...
  plotSt(string prefix, string sufix) {
    string histoName;
    histoName = prefix + "PreselEff" + sufix;
    PreselEff = new TH1D(histoName.c_str(), histoName.c_str(), 1, 0.0, 1.0);
    histoName = prefix + "TPsVNEvts" + sufix;
    TPsVNEvts = new TH1D(histoName.c_str(), histoName.c_str(), 1, 0.0, 1.0);
    histoName = prefix + "NVert" + sufix;
    NVert = new TH1D(histoName.c_str(), histoName.c_str(), 100, 0.0, 100);
    //      histoName=prefix + "PtBPS"        + sufix ; PtBPS        = new TH1D(histoName.c_str(), histoName.c_str(), 1000, 0.0,1000);
    histoName = prefix + "Pt" + sufix;
    Pt = new TH1D(histoName.c_str(), histoName.c_str(), 1000, 0.0, 1000);
    double EtaBins[] = {0.0, 0.9, 1.2, 2.1, 2.4};
    histoName = prefix + "PtEta" + sufix;
    PtEta =
        new TH2D(histoName.c_str(), histoName.c_str(), sizeof(EtaBins) / sizeof(double) - 1, EtaBins, 1000, 0.0, 1000);
    //      histoName=prefix + "PtErr"        + sufix ; PtErr        = new TH1D(histoName.c_str(), histoName.c_str(), 1000, 0.0,32.0);
    histoName = prefix + "dEdxHitStrip" + sufix;
    dEdxHitStrip = new TH1D(histoName.c_str(), histoName.c_str(), 400, 0.0, 20.0);
    histoName = prefix + "dEdxHitPixel" + sufix;
    dEdxHitPixel = new TH1D(histoName.c_str(), histoName.c_str(), 400, 0.0, 20.0);
    histoName = prefix + "dEdxMin1" + sufix;
    dEdxMin1 = new TH1D(histoName.c_str(), histoName.c_str(), 200, 0.0, 10.0);
    histoName = prefix + "dEdxMin2" + sufix;
    dEdxMin2 = new TH1D(histoName.c_str(), histoName.c_str(), 200, 0.0, 10.0);
    histoName = prefix + "dEdxMin3" + sufix;
    dEdxMin3 = new TH1D(histoName.c_str(), histoName.c_str(), 200, 0.0, 10.0);
    histoName = prefix + "dEdxMin4" + sufix;
    dEdxMin4 = new TH1D(histoName.c_str(), histoName.c_str(), 200, 0.0, 10.0);
    histoName = prefix + "dEdx" + sufix;
    dEdx = new TH1D(histoName.c_str(), histoName.c_str(), 100, 0.0, 1.0);
    histoName = prefix + "dEdxOld" + sufix;
    dEdxOld = new TH1D(histoName.c_str(), histoName.c_str(), 100, 0.0, 1.0);
    histoName = prefix + "dEdxMT" + sufix;
    dEdxMT = new TH1D(histoName.c_str(), histoName.c_str(), 200, 0.0, 10.0);
    histoName = prefix + "dEdxM" + sufix;
    dEdxM = new TH1D(histoName.c_str(), histoName.c_str(), 200, 0.0, 10.0);
    histoName = prefix + "dEdxMS" + sufix;
    dEdxMS = new TH1D(histoName.c_str(), histoName.c_str(), 200, 0.0, 10.0);
    histoName = prefix + "dEdxMP" + sufix;
    dEdxMP = new TH1D(histoName.c_str(), histoName.c_str(), 200, 0.0, 10.0);
    histoName = prefix + "dEdxMSC" + sufix;
    dEdxMSC = new TH1D(histoName.c_str(), histoName.c_str(), 200, 0.0, 10.0);
    histoName = prefix + "dEdxMPC" + sufix;
    dEdxMPC = new TH1D(histoName.c_str(), histoName.c_str(), 200, 0.0, 10.0);
    histoName = prefix + "dEdxMSF" + sufix;
    dEdxMSF = new TH1D(histoName.c_str(), histoName.c_str(), 200, 0.0, 10.0);
    histoName = prefix + "dEdxMPF" + sufix;
    dEdxMPF = new TH1D(histoName.c_str(), histoName.c_str(), 200, 0.0, 10.0);
    histoName = prefix + "TOF" + sufix;
    TOF = new TH1D(histoName.c_str(), histoName.c_str(), 100, -1.0, 3.0);
    histoName = prefix + "TOFDT" + sufix;
    TOFDT = new TH1D(histoName.c_str(), histoName.c_str(), 100, -1.0, 3.0);
    histoName = prefix + "TOFCSC" + sufix;
    TOFCSC = new TH1D(histoName.c_str(), histoName.c_str(), 100, -1.0, 3.0);
    histoName = prefix + "Vertex" + sufix;
    Vertex = new TH1D(histoName.c_str(), histoName.c_str(), 100, -10.0, 10.0);
    histoName = prefix + "VertexDT" + sufix;
    VertexDT = new TH1D(histoName.c_str(), histoName.c_str(), 100, -10.0, 10.0);
    histoName = prefix + "VertexCSC" + sufix;
    VertexCSC = new TH1D(histoName.c_str(), histoName.c_str(), 100, -10.0, 10.0);
  };
};
...
bool PassPreselection(const susybsm::HSCParticle& hscp,
  ...
  if (TypeMode == 1 && !(hscp.type() == HSCParticleType::trackerMuon || hscp.type() == HSCParticleType::globalMuon))
    return false;
  if (TypeMode == 2 && hscp.type() != HSCParticleType::globalMuon)
    return false;
  ...
  if (fabs(track->eta()) > GlobalMaxEta)
    return false;
  if (track->found() < GlobalMinNOH)
    return false;
  if (track->hitPattern().numberOfValidPixelHits() < 2)
    return false;
  ...
  if (track->qualityMask() < GlobalMinQual)
    return false;
  if (track->chi2() / track->ndof() > GlobalMaxChi2)
    return false;
  if (track->pt() < GlobalMinPt)
    return false;
  if (dedxSObj.dEdx() < GlobalMinIs)
    return false;
  if (dedxMObj.dEdx() < GlobalMinIm)
    return false;
  ...
  if ((track->ptError() / track->pt()) > GlobalMaxPterr)
    return false;
  if (std::max(0.0, track->pt() - track->ptError()) < GlobalMinPt)
    return false;
  return true;
}
...
bool PassingTrigger(const fwlite::ChainEvent& ev, const std::string& TriggerName) {
  ...
  if (TriggerName == "Any") {
    if (passTriggerPatterns(tr, "HLT_PFMET170_NoiseCleaned_v*"))
      return true;
    if (passTriggerPatterns(tr, "HLT_Mu45_eta2p1_v*"))
      return true;
    if (passTriggerPatterns(tr, "HLT_Mu50_v*"))
      return true;
  } else {
    if (passTriggerPatterns(tr, (TriggerName + "_v*").c_str()))
      return true;
  }
  return false;
}

void StabilityCheck(string DIRNAME = "COMPILE",
                    string OUTDIRNAME = "pictures",
                    string JobIndexStr = "0",
                    string NJobsStr = "1") {
  printf("DIRNAME = %s\n", DIRNAME.c_str());
  if (DIRNAME == "COMPILE")
    return;
  ...
  int JobIndex;
  sscanf(JobIndexStr.c_str(), "%d", &JobIndex);
  int NJobs;
  sscanf(NJobsStr.c_str(), "%d", &NJobs);
  char OutputFileName[1024];
  sprintf(OutputFileName, "%s/Histos_%i.root", OUTDIRNAME.c_str(), JobIndex);
  ...
  sscanf(JobIndexStr.c_str(), "%d", &sampleIdStart);
  sampleIdEnd = sampleIdStart;
  ...
  for (unsigned int s = 0; s < samples.size(); s++) {
    ...
    for (unsigned int f = 0; f < DataFileName.size(); f++) {
    ...
    dEdxTemplatesOld = loadDeDxTemplate(DIRNAME + (isData ? "/../../../data/Data13TeV16_dEdxTemplate.root"
                                                          : "/../../../data/MC13TeV16_dEdxTemplate.root"),
                                        true);
    ...
    for (Long64_t e = FirstEvent; e < FirstEvent + NEvents; e++) {
      ...
      if (!PassingTrigger(ev, "Any")) {
        continue;
      }  //need to pass at least one of the trigger, otherwise save time
      ...
      if (!TOFCSCCollH.isValid()) {
        printf("Invalid CSCTOF collection\n");
        continue;
      }
      ...
      for (unsigned int c = 0; c < hscpColl.size(); c++) {
        ...
        if (muon.isNull())
          continue;
        if (!hscp.muonRef()->isStandAloneMuon())
          continue;
        ...
        DeDxData PSdedxSObj = computedEdx(dedxHits,
                                          dEdxSF,
                                          dEdxTemplates,
                                          true,
                                          useClusterCleaning,
                                          ...
                                          false,
                                          1);
        DeDxData PSdedxMObj = computedEdx(dedxHits,
                                          dEdxSF,
                                          NULL,
                                          true,
                                          useClusterCleaning,
        ...
        if (!hscp.muonRef().isNull() && hscp.muonRef()->isStandAloneMuon()) {
          if (isMC) {
            PStof = &TOFCollH->get(hscp.muonRef().key());
            PSdttof = &TOFDTCollH->get(hscp.muonRef().key());
            PScsctof = &TOFCSCCollH->get(hscp.muonRef().key());
          } else {
            ...
            PStof = &tofCalculator.combinedTOF;
            PSdttof = &tofCalculator.dtTOF;
            PScsctof = &tofCalculator.cscTOF;
          }
        }
        ...
        if (!PassPreselection(hscp, PSdedxSObj, PSdedxMObj, PStof, PSdttof, PScsctof, ev)) {
          continue;
        }
        if (!alreadyPassed) {
          totalPreselEvents += 1;
        ...
        totalPreselTracks += 1;
        for (unsigned int i = 0; i < triggers.size(); i++) {
          if (!PassingTrigger(ev, triggers[i])) {
            continue;
          }
          for (unsigned int v = 0; v < versions.size(); v++) {
            plotSt* plots = (*MapTriggerPlots)[triggers[i] + versions[v]];
            std::map<unsigned int, TH1D**>::iterator dEdxHitPerLumiIt =
                plots->dEdxHitPerLumi.find(ev.eventAuxiliary().luminosityBlock());
            if (dEdxHitPerLumiIt == plots->dEdxHitPerLumi.end()) {
              char LUMI[256];
              sprintf(LUMI, "_ls%i", ev.eventAuxiliary().luminosityBlock());
              ...
              (dEdxHitPerLumiIt->second)[0] =
                  (TH1D*)plots->NVert->Clone((string(plots->NVert->GetName()) + LUMI).c_str());
              (dEdxHitPerLumiIt->second)[1] =
                  (TH1D*)plots->dEdxHitPixel->Clone((string(plots->dEdxHitPixel->GetName()) + LUMI).c_str());
              (dEdxHitPerLumiIt->second)[2] =
                  (TH1D*)plots->dEdxHitStrip->Clone((string(plots->dEdxHitStrip->GetName()) + LUMI).c_str());
            ...
            bool fake = false;
            if (versions[v] == "FAKE" && !isData)
              fake = true;

            HitDeDxCollection hitDeDx = getHitDeDx(dedxHits, dEdxSF, tkGains, false, 1);
            if (fake)
              HIPemulator.fakeHIP(hitDeDx);
            for (unsigned int h = 0; h < hitDeDx.size(); h++) {
              if ((useClusterCleaning && !hitDeDx[h].passClusterCleaning) || !hitDeDx[h].isInside)
                continue;
              if (hitDeDx[h].subDet < 3) {
                plots->dEdxHitPixel->Fill(hitDeDx[h].dedx);
                (dEdxHitPerLumiIt->second)[1]->Fill(hitDeDx[h].dedx);
              }
              if (hitDeDx[h].subDet >= 3) {
                plots->dEdxHitStrip->Fill(hitDeDx[h].dedx);
                (dEdxHitPerLumiIt->second)[2]->Fill(hitDeDx[h].dedx);
              }
              //(dEdxHitPerLumiIt->second)[2+hitDeDx[h].subDet]->Fill(hitDeDx[h].dedx);
            }

            DeDxData dedxMin1Obj = computedEdx(dedxHits,
                                               dEdxSF,
                                               NULL,
                                               true,
                                               useClusterCleaning,
                                               ...
                                               1,
                                               0.15,
                                               fake ? &HIPemulator : NULL);
            DeDxData dedxMin2Obj = computedEdx(dedxHits,
                                               dEdxSF,
                                               NULL,
                                               true,
                                               useClusterCleaning,
                                               ...
                                               0.2,
                                               fake ? &HIPemulator : NULL);
            DeDxData dedxMin3Obj = computedEdx(dedxHits,
                                               dEdxSF,
                                               NULL,
                                               true,
                                               useClusterCleaning,
                                               ...
                                               0.3,
                                               fake ? &HIPemulator : NULL);
            DeDxData dedxMin4Obj = computedEdx(dedxHits,
                                               dEdxSF,
                                               NULL,
                                               true,
                                               useClusterCleaning,
                                               ...
                                               0.4,
                                               fake ? &HIPemulator : NULL);
            DeDxData dedxSObj = computedEdx(dedxHits,
                                            dEdxSF,
                                            dEdxTemplates,
                                            true,
                                            useClusterCleaning,
                                            ...
                                            0.0,
                                            fake ? &HIPemulator : NULL);
            DeDxData dedxSObjOld = computedEdx(dedxHits,
                                               dEdxSF,
                                               dEdxTemplatesOld,
                                               true,
                                               useClusterCleaning,
                                               ...
                                               0.0,
                                               fake ? &HIPemulator : NULL);
            DeDxData dedxMObj = computedEdx(dedxHits,
                                            dEdxSF,
                                            NULL,
                                            true,
                                            useClusterCleaning,
                                            ...
                                            0.0,
                                            fake ? &HIPemulator : NULL);
            DeDxData dedxMTObj = computedEdx(dedxHits,
                                             dEdxSF,
                                             NULL,
                                             true,
                                             useClusterCleaning,
                                             ...
                                             0.0,
                                             fake ? &HIPemulator : NULL);
            DeDxData dedxMSObj = computedEdx(dedxHits,
                                             dEdxSF,
                                             NULL,
                                             false,
                                             useClusterCleaning,
                                             ...
                                             0.0,
                                             fake ? &HIPemulator : NULL);
            DeDxData dedxMPObj = computedEdx(dedxHits,
                                             dEdxSF,
                                             NULL,
                                             true,
                                             useClusterCleaning,
            ...
            if (plotPerEvent) {
              ...
              (dEdxHitPerLumiIt->second)[0]->Fill(vertexColl.size());
            }
            ...
            if (tof && tof->nDof() >= GlobalMinNDOF &&
                (dttof->nDof() >= GlobalMinNDOFDT || csctof->nDof() >= GlobalMinNDOFCSC) &&
                tof->inverseBetaErr() <= GlobalMaxTOFErr && fabs(dttof->inverseBeta() - 1) < 50) {
              plots->TOF->Fill(tof->inverseBeta());
              if (dttof->nDof() >= GlobalMinNDOFDT)
                plots->TOFDT->Fill(dttof->inverseBeta());
              if (csctof->nDof() >= GlobalMinNDOFCSC)
                plots->TOFCSC->Fill(csctof->inverseBeta());
              plots->Vertex->Fill(tof->timeAtIpInOut());
              if (dttof->nDof() >= GlobalMinNDOFDT)
                plots->VertexDT->Fill(dttof->timeAtIpInOut());
              if (csctof->nDof() >= GlobalMinNDOFCSC)
                plots->VertexCSC->Fill(csctof->timeAtIpInOut());
            }
