...
void MuonTimingFiller_Mini::fillTiming(const pat::Muon& muon,
...
void MuonTimingFiller_Mini::fillTimeFromMeasurements(const TimeMeasurementSequence& tmSeq,
...
void MuonTimingFiller_Mini::fillRPCTime(const pat::Muon& muon, reco::MuonTime& rpcTime, edm::Event& iEvent) {
...
void MuonTimingFiller_Mini::combineTMSequences(const pat::Muon& muon,
...
void MuonTimingFiller_Mini::addEcalTime(const pat::Muon& muon, TimeMeasurementSequence& cmbSeq) {
...
void MuonTimingFiller_Mini::rawFit(double& freeBeta,
                                   double& freeBetaErr,
                                   double& freeTime,
                                   double& freeTimeErr,
