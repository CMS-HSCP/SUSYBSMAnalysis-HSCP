...
config.General.requestName = 'Analysis_Cosmics_Prompt2017_wProbQNoL1NoProbXYWImpParCut_v1'
...
config.Data.inputDataset = '/Cosmics/Commissioning2017-PromptReco-v1/AOD'
