...
config.General.requestName = 'Analysis_QCDwPt50To80_woProbQ_CodeV4p6_isData_v1'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True

config.section_('JobType')
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'HSCParticleProducerAnalyzer_mc_isData_woProbQ_cfg.py'
