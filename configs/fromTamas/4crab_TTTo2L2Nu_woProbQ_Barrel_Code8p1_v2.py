...
config.General.requestName = 'Analysis_2018_TTTo2L2Nu_woProbQ_Barrel_CodeV8p1_v2'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True

config.section_('JobType')
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'HSCParticleProducerAnalyzer_2018_mc_woProbQ_Barrel_cfg.py'
