...
config.General.requestName = 'Analysis_MET_UL2017D'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'HSCParticleProducerAnalyzer_2017D_cfg.py'
config.JobType.allowUndistributedCMSSW = True

config.JobType.inputFiles = ['HSCP/data/Data13TeVGains_v2.root','HSCP/data/dEdxTemplate_harm2_SO_in_noC_CCC_MG_2017D.root','HSCP/data/CMS_GeomTree.root','HSCP/data/MuonTimeOffset.txt']

test=False
if test:
    config.Data.userInputFiles = ['root://cms-xrd-global.cern.ch//store/data/Run2017D/MET/AOD/09Aug2019_UL2017_rsb-v1/120000/005E3EF6-8DEC-4841-A1E3-3DBC6321FDDD.root']
    config.Data.outputPrimaryDataset = 'store'
    config.Data.splitting = 'FileBased'
    config.Data.unitsPerJob = 1
else:
    config.Data.inputDataset = '/MET/Run2017D-09Aug2019_UL2017_rsb-v1/AOD'    
...
if __name__=='__main__':
    ...
    datasetlist = ['/MET/Run2017D-09Aug2019_UL2017_rsb-v1/AOD']
