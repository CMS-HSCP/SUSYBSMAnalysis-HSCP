...
config.General.requestName = 'Analysis_MET_UL2017F'
...
test=False
if test:
    config.Data.userInputFiles = ['root://cms-xrd-global.cern.ch//store/data/Run2017F/MET/AOD/09Aug2019_UL2017_rsb-v1/110000/F24FBC6F-FAAF-EC42-8102-7B041AFFF324.root']
    config.Data.outputPrimaryDataset = 'store'
    config.Data.splitting = 'FileBased'
    config.Data.unitsPerJob = 1
else:
    config.Data.inputDataset = '/MET/Run2017F-09Aug2019_UL2017_rsb-v1/AOD'    
...
if __name__=='__main__':
    ...
    datasetlist = ['/MET/Run2017F-09Aug2019_UL2017_rsb-v1/AOD']
