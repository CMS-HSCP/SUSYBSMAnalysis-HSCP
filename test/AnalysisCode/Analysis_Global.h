...
double             PtHistoUpperBound   = 4000; //1200;
double             MassHistoUpperBound = 4000; //3000;
int                MassNBins           = 400; //300;
double             IPbound             = 1.0;
...
double             dEdxK_Data17    = 2.37; //updated values from Dylan
double             dEdxC_Data17    = 2.93; //updated values from Dylan
