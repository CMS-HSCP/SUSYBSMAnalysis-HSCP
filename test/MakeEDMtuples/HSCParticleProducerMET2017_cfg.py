...
process.HSCPTriggerMET = process.hltHighLevel.clone()
process.HSCPTriggerMET.TriggerResultsTag = cms.InputTag( "TriggerResults", "", "HLT" )
process.HSCPTriggerMET.andOr = cms.bool( True ) #OR
process.HSCPTriggerMET.throw = cms.bool( False )
process.HSCPTriggerMET.HLTPaths = [ #check triggers
    "HLT_PFMET120_PFMHT120_IDTight_v*",
    ]

process.HSCPTriggerSingleMu = process.hltHighLevel.clone()
process.HSCPTriggerSingleMu.TriggerResultsTag = cms.InputTag( "TriggerResults", "", "HLT" )
process.HSCPTriggerSingleMu.andOr = cms.bool( True ) #OR                                                                                                                            
process.HSCPTriggerSingleMu.throw = cms.bool( False )
process.HSCPTriggerSingleMu.HLTPaths = [ #check triggers                                                                                                                         
    "HLT_Mu50_v*",
   ]
    
process.HSCPTuplePath += process.nEventsBefSkim + (process.HSCPTriggerMET * ~process.HSCPTriggerSingleMu)
