...
// Thu Apr 25 10:39:50 2019 by ROOT version 6.10/09
// from TTree ttree/ttree
// found on file: /opt/sbg/cms/ui3_data1/ccollard/HSCP/gluino2400_step3/stage_from_step2_gluino_1.root
//////////////////////////////////////////////////////////

#ifndef GluinoAnalysis_h
#define GluinoAnalysis_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           event;
   Int_t           ngenpart;
   Int_t           gen_pdg[1000];   //[ngenpart]
   Float_t         gen_pt[1000];   //[ngenpart]
   Float_t         gen_eta[1000];   //[ngenpart]
   Float_t         gen_phi[1000];   //[ngenpart]
   Bool_t          gen_isHardProcess[1000];   //[ngenpart]
   Int_t           gen_status[1000];   //[ngenpart]
   Int_t           gen_moth_pdg[1000];   //[ngenpart]
   Int_t           gen_ndaughter[1000];   //[ngenpart]
   Int_t           gen_daughter_pdg[1000];   //[ngenpart]
   Int_t           ntracks;
   Float_t         track_pt[1000];   //[ntracks]
   Float_t         track_p[1000];   //[ntracks]
   Float_t         track_eta[1000];   //[ntracks]
   Float_t         track_phi[1000];   //[ntracks]
   Float_t         track_chi2[1000];   //[ntracks]
   Int_t           track_nvalidhits[1000];   //[ntracks]
   Int_t           track_index_hit[1000];   //[ntracks]
   Int_t           track_nhits[1000];   //[ntracks]
   Float_t         track_ih_ampl[1000];   //[ntracks]
   Float_t         track_ih_ampl_corr[1000];   //[ntracks]
   Float_t         track_ias_ampl[1000];   //[ntracks]
   Float_t         track_ias_ampl_corr[1000];   //[ntracks]
   Int_t           ndedxhits;
   UInt_t          dedx_detid[10000];   //[ndedxhits]
   Int_t           dedx_subdetid[10000];   //[ndedxhits]
   Int_t           dedx_modulgeom[10000];   //[ndedxhits]
   Float_t         dedx_charge[10000];   //[ndedxhits]
   Float_t         dedx_pathlength[10000];   //[ndedxhits]
   Float_t         dedx_posx[10000];   //[ndedxhits]
   Float_t         dedx_posy[10000];   //[ndedxhits]
   Float_t         dedx_posz[10000];   //[ndedxhits]
   Bool_t          dedx_isstrip[10000];   //[ndedxhits]
   Bool_t          dedx_ispixel[10000];   //[ndedxhits]
   Bool_t          dedx_insideTkMod[10000];   //[ndedxhits]
   Int_t           sclus_firstsclus[10000];   //[ndedxhits]
   Float_t         sclus_barycenter[10000];   //[ndedxhits]
   Float_t         sclus_charge[10000];   //[ndedxhits]
   Float_t         sclus_errorclus[10000];   //[ndedxhits]
   Bool_t          sclus_ismerged[10000];   //[ndedxhits]
   Int_t           sclus_index_strip[10000];   //[ndedxhits]
   Int_t           sclus_nstrip[10000];   //[ndedxhits]
   Bool_t          sclus_sat254[10000];   //[ndedxhits]
   Bool_t          sclus_sat255[10000];   //[ndedxhits]
   Bool_t          sclus_shape[10000];   //[ndedxhits]
   Int_t           sclus_index_strip_corr[10000];   //[ndedxhits]
   Int_t           sclus_nstrip_corr[10000];   //[ndedxhits]
   Float_t         sclus_charge_corr[10000];   //[ndedxhits]
   Bool_t          sclus_clusclean[10000];   //[ndedxhits]
   Bool_t          sclus_clusclean2[10000];   //[ndedxhits]
   Int_t           sclus_index_simhit[10000];   //[ndedxhits]
   Int_t           sclus_nsimhit[10000];   //[ndedxhits]
   Float_t         sclus_eloss[10000];   //[ndedxhits]
   Int_t           nstrips;
   Int_t           strip_ampl[80000];   //[nstrips]
   Int_t           nstrips_corr;
   Int_t           strip_ampl_corr[80000];   //[nstrips_corr]
   Int_t           nsimhits;
   ...
   GluinoAnalysis(TTree *tree=0);
   virtual ~GluinoAnalysis();
...
#ifdef GluinoAnalysis_cxx
GluinoAnalysis::GluinoAnalysis(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/opt/sbg/cms/ui3_data1/ccollard/HSCP/gluino2400_step3/stage_from_step2_gluino_1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/opt/sbg/cms/ui3_data1/ccollard/HSCP/gluino2400_step3/stage_from_step2_gluino_1.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/opt/sbg/cms/ui3_data1/ccollard/HSCP/gluino2400_step3/stage_from_step2_gluino_1.root:/stage");
...
GluinoAnalysis::~GluinoAnalysis()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t GluinoAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t GluinoAnalysis::LoadTree(Long64_t entry)
{
...
void GluinoAnalysis::Init(TTree *tree)
{
...
void GluinoAnalysis::Show(Long64_t entry)
{
...
Int_t GluinoAnalysis::Cut(Long64_t entry)
{
...
#endif // #ifdef GluinoAnalysis_cxx
