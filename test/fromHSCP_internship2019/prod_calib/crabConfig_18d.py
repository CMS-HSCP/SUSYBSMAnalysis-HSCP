...
config.General.requestName = 'zbias_18d'
...
config.JobType.psetName = 'reco_alca_18d.py'
...
config.Data.outputDatasetTag = 'run2018D_v2'
config.Data.outLFNDirBase = '/store/user/ccollard/HSCP/prodNov2019_CMSSW_10_6_2/'
